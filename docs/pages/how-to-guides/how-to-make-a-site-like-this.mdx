...
The only cost to do this is that of the domain name you want (and you could even forego that too if you just want to use the url that vercel gives you as a default) - the three services need to do this (Cloudflare, Github, and Vercel) have a free tier that the vast majority of these types of sites will stay well within the free tier for.
